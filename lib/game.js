...
exports.Server.prototype=Game.util.extend(ev.EventEmitter,{
	...
	init:function(gamefile,options){
		...
		this.generator.init(this.gamefile);
		//ゲーム起動
...
RespGenerator.prototype={
	init:function(gamefile){
		//初期化 gamefile: フルパス?
		this.packScripts(gamefile);
	},
	packScripts:function(gamefile){
		//結合するファイル
		var files=["../module/EventEmitter.min.js","engine.js","client.js",gamefile];
