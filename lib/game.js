...
HTMLGenerator.prototype={
	generate:function(option){
		var srv=this.server;
		//HTMLを生成
		var head1="<!doctype html>\n<html><head><meta charset='"+srv.encoding+"'><title>"+srv.options.title+"</title><script type='text/javascript' src='/socket.io/socket.io.js'></script><script type='text/javascript'>var _g_option="+JSON.stringify(option)+";</script>";
		//ここでcssを送る
